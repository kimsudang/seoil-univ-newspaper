...
public class ReportPageController {
	...
	private ArrayList<ReportVO> messageList; 
	private int pageTotalCount; 
	private int messageCountPerPage;
	private int firstRow; //ù��
	private int endRow; //������ ��

	public ReportPageController(ArrayList<ReportVO> messageList, int messageTotalCount, 
	...
	public ArrayList<ReportVO> getMessageList() {
		return messageList;
	}
	...
	public void setMessageList(ArrayList<ReportVO> messageList) {
		this.messageList = messageList;
	}
